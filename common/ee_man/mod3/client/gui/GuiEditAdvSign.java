...
import ee_man.mod3.blocks.BlockAdvSign;
...
public class GuiEditAdvSign extends GuiScreen{
	...
	public void onGuiClosed(){
		...
		try{
			...
			data.writeByte(this.entitySign.red);
			data.writeByte(this.entitySign.green);
			data.writeByte(this.entitySign.blue);
			Packet.writeString(this.entitySign.signText, data);
		} catch(IOException e){
			e.printStackTrace();
		}
	...
	public void drawScreen(int par1, int par2, float par3){
		...
		this.drawString(this.fontRenderer, "Lines:" + this.entitySign.getLines(), this.width / 2 + 19, this.height / 4 + 110, 16777215);
		this.drawString(this.fontRenderer, "B:" + (this.entitySign.blue + 128), this.width / 2 + 29 + 30, this.height / 4 + 89, 16777215);
		this.drawString(this.fontRenderer, "G:" + (this.entitySign.green + 128), this.width / 2 + 29 + 30, this.height / 4 + 68, 16777215);
		this.drawString(this.fontRenderer, "R:" + (this.entitySign.red + 128), this.width / 2 + 29 + 30, this.height / 4 + 47, 16777215);
		GL11.glPushMatrix();
	...
	private boolean canAddChar(String par1, int par2, char par3){
		return(this.fontRenderer.getStringWidth(par1 + par3) < (int)((float)92 / ((float)4 / (float)par2)));
	}
