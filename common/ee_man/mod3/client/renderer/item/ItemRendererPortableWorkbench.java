...
import ee_man.mod3.client.renderer.model.ModelPortableWorkbench;
...
public class ItemRendererPortableWorkbench implements IItemRenderer{
	...
	final ResourceLocation Texture = new ResourceLocation(DefaultProperties.TEXTURE_ID, DefaultProperties.TEXTURE_FOLDER + "portableWorkbench.png");
