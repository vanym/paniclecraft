...
public class TileEntityChessDeskRenderer extends TileEntitySpecialRenderer{
	...
	private final ResourceLocation Texture = new ResourceLocation(DefaultProperties.TEXTURE_ID, DefaultProperties.TEXTURE_FOLDER + "chess/ChessDesk.png");
	private final ResourceLocation TextureW = new ResourceLocation(DefaultProperties.TEXTURE_ID, DefaultProperties.TEXTURE_FOLDER + "chess/w.png");
	private final ResourceLocation TextureB = new ResourceLocation(DefaultProperties.TEXTURE_ID, DefaultProperties.TEXTURE_FOLDER + "chess/b.png");
