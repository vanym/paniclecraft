...
public class TileEntityAdvSignRenderer extends TileEntitySpecialRenderer{
	...
	public void renderTileEntitySignAt(TileEntityAdvSign par1TileEntitySign, double par2, double par4, double par6, float par8){
		...
		GL11.glColor4f((float)(par1TileEntitySign.red + 128) / 255.0F, ((float)par1TileEntitySign.green + 128) / 255.0F, ((float)par1TileEntitySign.blue + 128) / 255.0F, 1.0F);
		...
		if(par1TileEntitySign.signText != null){
			String[] var20 = par1TileEntitySign.signText.split(TileEntityAdvSign.separator, par1TileEntitySign.getLines());
			...
			for(int var14 = 0; var14 < par1TileEntitySign.getLines(); ++var14){
				...
				if(var14 == par1TileEntitySign.lineBeingEdited)
					var15 = "> " + var15 + " <";
				if(var17 != null)
					var17.drawString(var15, -var17.getStringWidth(var15) / 2, var14 * 10 - par1TileEntitySign.getLines() * 5, var13);
			}
		}
