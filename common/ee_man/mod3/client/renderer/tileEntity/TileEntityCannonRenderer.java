...
public class TileEntityCannonRenderer extends TileEntitySpecialRenderer{
	...
	final ResourceLocation Texture = new ResourceLocation(DefaultProperties.TEXTURE_ID, DefaultProperties.TEXTURE_FOLDER + "cannon.png");
	...
	public void renderTileEntityAt(TileEntityCannon par1, double par2, double par4, double par6, float par8){
		...
		body.render(0.0625F);
		GL11.glRotatef(par1.direction, 0.0F, 1.0F, 0.0F);
		body2.render(0.075F);
		GL11.glTranslatef(0.0F, -0.4F, 0.0F);
		GL11.glRotatef(90F - par1.height, 1.0F, 0.0F, 0.0F);
		body3.render(0.075F);
		GL11.glPopMatrix();
	}
