...
public class ContainerPalette extends Container{
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 0){
				...
				if(itemstack1.itemID == Core.itemPaintBrush.itemID && this.mergeItemStack(itemstack1, 0, 1, true)){
	...
	public void onCraftGuiClosed(EntityPlayer par1EntityPlayer){
		...
		if(inventoryPalette.item != null){
			par1EntityPlayer.dropPlayerItem(inventoryPalette.item);
	...
	public static boolean canBePalette(ItemStack par1){
		return par1 == null ? false : par1.itemID == Core.itemPalette.itemID && par1.stackSize > 0;
	}
}
