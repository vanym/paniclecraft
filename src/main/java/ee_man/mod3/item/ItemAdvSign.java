				...
				if(!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)){
					...
					if(!post.canPlaceBlockAt(par3World, par4, par5, par6)){
						...
						if(par7 == 1){
							...
							par3World.setBlock(par4, par5, par6, post, var11, 3);
						}
						else{
							par3World.setBlock(par4, par5, par6, wall, par7, 3);
						}
						
						--par1ItemStack.stackSize;
						TileEntityAdvSign var12 = (TileEntityAdvSign)par3World.getTileEntity(par4, par5, par6);
						...
						if(var12 != null){
							...
							par2EntityPlayer.openGui(Core.instance, GUIs.ADVSIGN.ordinal(), par3World, par4, par5, par6);
						}
