...
public class ItemChessDesk extends ItemMod3{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10){
		...
		if(!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) || !ModItems.blockChessDesk.canPlaceBlockAt(par3World, par4, par5, par6)){
			return false;
		}
		else{
			...
			TileEntityChessDesk tile = (TileEntityChessDesk)par3World.getTileEntity(par4, par5, par6);
