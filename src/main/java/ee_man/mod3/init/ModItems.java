...
import ee_man.mod3.block.BlockAdvSign;
import ee_man.mod3.block.BlockCannon;
import ee_man.mod3.block.BlockChessDesk;
import ee_man.mod3.block.BlockPainting;
import ee_man.mod3.block.BlockPaintingFrame;
import ee_man.mod3.core.CreativeTabMod3;
import ee_man.mod3.item.ItemAdvSign;
import ee_man.mod3.item.ItemBroom;
import ee_man.mod3.item.ItemCannon;
import ee_man.mod3.item.ItemChessDesk;
import ee_man.mod3.item.ItemMod3;
import ee_man.mod3.item.ItemPaintBrush;
import ee_man.mod3.item.ItemPainting;
import ee_man.mod3.item.ItemPalette;
import ee_man.mod3.item.ItemWorkbench;
import ee_man.mod3.recipe.RecipePaintBrushByDye;
import ee_man.mod3.recipe.RecipePaintBrushByPaintFiller;
