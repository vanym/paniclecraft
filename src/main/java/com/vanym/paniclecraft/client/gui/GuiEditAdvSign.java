...
public class GuiEditAdvSign extends GuiScreen {
    ...
    public void initGui() {
        this.buttonMinus = new GuiButton(1, this.width / 2 + 80, this.height / 4 + 99, 20, 20, "-");
        this.buttonPlus = new GuiButton(2, this.width / 2 + 59, this.height / 4 + 99, 20, 20, "+");
        this.buttonMinusBlue =
                new GuiButton(10, this.width / 2 + 80 + 30, this.height / 4 + 78, 20, 20, "-");
        this.buttonPlusBlue =
                new GuiButton(11, this.width / 2 + 59 + 30, this.height / 4 + 78, 20, 20, "+");
        this.buttonMinusGreen =
                new GuiButton(8, this.width / 2 + 80 + 30, this.height / 4 + 57, 20, 20, "-");
        this.buttonPlusGreen =
                new GuiButton(9, this.width / 2 + 59 + 30, this.height / 4 + 57, 20, 20, "+");
        this.buttonMinusRed =
                new GuiButton(6, this.width / 2 + 80 + 30, this.height / 4 + 36, 20, 20, "-");
        this.buttonPlusRed =
                new GuiButton(7, this.width / 2 + 59 + 30, this.height / 4 + 36, 20, 20, "+");
        this.buttonCleanColor =
                new GuiButton(12, this.width / 2 + 80 + 30, this.height / 4 + 15, 20, 20, "CC");
        this.buttonCleanText =
                new GuiButton(13, this.width / 2 + 59 + 30, this.height / 4 + 15, 20, 20, "CT");
        if (this.entitySign.getLines() == 1) {
            this.buttonMinus.enabled = false;
        } else if (this.entitySign.getLines() == 32) {
            this.buttonPlus.enabled = false;
        }
        this.buttonList.clear();
        Keyboard.enableRepeatEvents(true);
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, "Done"));
        this.buttonList.add(this.buttonMinus);
        this.buttonList.add(this.buttonPlus);
        this.buttonList.add(this.buttonMinusRed);
        this.buttonList.add(this.buttonPlusRed);
        this.buttonList.add(this.buttonMinusGreen);
        this.buttonList.add(this.buttonPlusGreen);
        this.buttonList.add(this.buttonMinusBlue);
        this.buttonList.add(this.buttonPlusBlue);
        this.buttonList.add(this.buttonCleanColor);
        this.buttonList.add(this.buttonCleanText);
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        if (par1GuiButton.enabled) {
            ...
            if (par1GuiButton.id == 1) {
                if (this.entitySign.getLines() != 1) {
                    String[] var1 = this.entitySign.signText.split(TileEntityAdvSign.separator,
                                                                   this.entitySign.getLines());
                    String var2 = "";
                    ...
                    } else if (this.entitySign.getLines() == 1) {
                        this.buttonMinus.enabled = false;
                    }
                }
            } else
            ...
            if (par1GuiButton.id == 2) {
                if (this.entitySign.getLines() != 32) {
                    this.entitySign.signText =
                            this.entitySign.signText + TileEntityAdvSign.separator;
                }
                if (this.entitySign.getLines() == 32) {
                    this.buttonPlus.enabled = false;
                } else if (this.entitySign.getLines() == 2) {
            ...
            if (par1GuiButton.id == 3) {
                ...
                if (this.canAddChar(par1, this.entitySign.getLines(), (char)167)) {
            ...
            if (par1GuiButton.id == 5) {
                this.setSignText(GuiScreen.getClipboardString());
                ...
                this.entitySign.signText =
                        TileEntityAdvSign.separator + TileEntityAdvSign.separator +
                                           TileEntityAdvSign.separator +
                                           TileEntityAdvSign.separator;
            }
        }
    }
            ...
            default:
                switch (par2) {
                    ...
                    case 211:
                        ...
                        if (var5.length() > 0) {
                            this.entitySign.editLine(this.editLine,
                                                     var5.substring(1, var5.length()));
                        }
                    break;
                    /*
                     * case 199: if (GuiScreen.isShiftKeyDown()) { this.setSelectionPos(0); } else {
                     * this.setCursorPositionZero(); } break; case 203: if
                     * (GuiScreen.isShiftKeyDown()) { if (GuiScreen.isCtrlKeyDown()) {
                     * this.setSelectionPos(this.getNthWordFromPos(-1, this.getSelectionEnd())); }
                     * else { this.setSelectionPos(this.getSelectionEnd() - 1); } } else if
                     * (GuiScreen.isCtrlKeyDown()) {
                     * this.setCursorPosition(this.getNthWordFromCursor(-1)); } else {
                     * this.moveCursorBy(-1); } break; case 205: if (GuiScreen.isShiftKeyDown()) {
                     * if (GuiScreen.isCtrlKeyDown()) {
                     * this.setSelectionPos(this.getNthWordFromPos(1, this.getSelectionEnd())); }
                     * else { this.setSelectionPos(this.getSelectionEnd() + 1); } } else if
                     * (GuiScreen.isCtrlKeyDown()) {
                     ...
                     *
                     * return true; case 211: if (GuiScreen.isCtrlKeyDown()) { this.deleteWords(1);
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 40,
                                16777215);
        this.drawString(this.fontRendererObj, "Lines:" + this.entitySign.getLines(),
                        this.width / 2 + 19, this.height / 4 + 110, 16777215);
        this.drawString(this.fontRendererObj, "B:" + (this.entitySign.blue + 128),
                        this.width / 2 + 29 + 30, this.height / 4 + 89, 16777215);
        this.drawString(this.fontRendererObj, "G:" + (this.entitySign.green + 128),
                        this.width / 2 + 29 + 30, this.height / 4 + 68, 16777215);
        this.drawString(this.fontRendererObj, "R:" + (this.entitySign.red + 128),
                        this.width / 2 + 29 + 30, this.height / 4 + 47, 16777215);
        GL11.glPushMatrix();
    ...
    private void addText(char par1, int par2) {
        this.addText(Character.toString(par1), par2);
    }
    ...
    /*
     * private String getLine(int par1){ String[] var1 = this.entitySign.signText
     * .split(this.entitySign.separator,this.entitySign.lines); return var1[par1]; }
     *
     * private void editLine(int par1,String par2){ String[] var1 = this.entitySign
     * .signText.split(this.entitySign.separator,this.entitySign.lines); var1[par1] = par2; String
     * var3 = ""; for(int var2 = 0;var2 < this.entitySign.lines;++var2){ var3 = var3 + var1[var2];
     * if(var2 != this.entitySign.lines - 1)var3 = var3 + this.entitySign.separator; }
     * this.entitySign.signText = var3; }
     */
    
    /*
     * private boolean canAddChar(String par1,int par2){ Iterator var10 =
     * this.fontRenderer.listFormattedStringToWidth(par1, 6 * ((int)((float)15 / ((float)4 /
     * (float)par2)))).iterator(); String var6 = (String)var10.next(); return !(var6.length() <
     * par1.length()); }
     */
    
    private boolean canAddChar(String par1, int par2, char par3) {
        return (this.fontRendererObj.getStringWidth(par1 + par3) < (int)((float)92 /
                                                                         ((float)4 / (float)par2)));
    }
