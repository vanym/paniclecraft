...
public class GuiPalette extends GuiContainer {
    ...
    public void initGui() {
        ...
        int var3 = var1 - 50;
        int var4 = var2 - 66;
        this.buttonMinusRed = new GuiButton(0, var3 + 15, var4, 15, 15, "-");
        this.buttonPlusRed = new GuiButton(1, var3, var4, 15, 15, "+");
        this.buttonMinusGreen = new GuiButton(2, var3 + 15, var4 + 15, 15, 15, "-");
        this.buttonPlusGreen = new GuiButton(3, var3, var4 + 15, 15, 15, "+");
        this.buttonMinusBlue = new GuiButton(4, var3 + 15, var4 + 30, 15, 15, "-");
        this.buttonPlusBlue = new GuiButton(5, var3, var4 + 30, 15, 15, "+");
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString(this.container.inventoryPalette.hasCustomInventoryName() ? this.container.inventoryPalette.getInventoryName()
                                                                                                 : StatCollector.translateToLocal(this.container.inventoryPalette.getInventoryName() +
                                                                                                     ".name")
                                                                                                                .trim(),
                                        8, 6, 4210752);
        this.fontRendererObj.drawString(this.container.inventoryPlayer.hasCustomInventoryName() ? this.container.inventoryPlayer.getInventoryName()
                                                                                                : I18n.format(this.container.inventoryPlayer.getInventoryName(),
                                                                                                              new Object[0]),
