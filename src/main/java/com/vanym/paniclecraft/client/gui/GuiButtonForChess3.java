...
public class GuiButtonForChess3 extends GuiButton {
    ...
    public GuiButtonForChess3(int par1,
            int par2,
            int par3,
            FontRenderer par4,
            int par5,
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        ...
        this.drawTexturedModalRect(this.xPosition, this.yPosition,
                                   (this.width == 5 ? this.width * 4 : 0), 4 * this.height,
                                   this.width, this.height);
        if (var4) {
            this.drawString(this.fontRenderer, this.displayString, par2, par3 - 7, 16777215);
        }
    }
}
