...
public class GuiButtonForChess2 extends GuiButton {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        ...
        this.drawTexturedModalRect(this.xPosition, this.yPosition, this.width * (var4 ? 1 : 2), 0,
                                   this.width, this.height);
        this.drawTexturedModalRect(this.xPosition, this.yPosition, var5,
                                   this.height * (this.id > 0 ? 1 : 2), this.width, this.height);
    }
}
