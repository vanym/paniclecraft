...
public class TileEntityPaintingFrameRenderer extends TileEntitySpecialRenderer {
        ...
        for(int i = 0; i < par1.getPaintings().length; i++) {
            ...
            if (picture != null) {
                ...
                if (picture.hasPic()) {
                    ...
                    textureBuffer.flip();
                    GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGB, picture.getRow(),
                                      picture.getRow(), 0, GL11.GL_RGB, GL11.GL_UNSIGNED_BYTE,
                                      textureBuffer);
                    picture.delPic();
                } else {
                    GL11.glBindTexture(GL11.GL_TEXTURE_2D, picture.texID);
    ...
    public void renderTileEntityAt(
            ...
            double par6,
            float par8) {
        this.renderTileEntityAt((TileEntityPaintingFrame)par1, par2, par4, par6, par8);
    }
    ...
    public void drawBa() {
        ...
        tessellator.addVertexWithUV(8F - 1F, 8F - 1F, -1.0F, xOffset + onePixel * 1,
                                    yOffset + onePixel * 1);
        tessellator.addVertexWithUV(8F - 15F, 8F - 1F, -1.0F, xOffset + onePixel * 15,
                                    yOffset + onePixel * 1);
        tessellator.addVertexWithUV(8F - 15F, 8F - 15F, -1.0F, xOffset + onePixel * 15,
                                    yOffset + onePixel * 15);
        tessellator.addVertexWithUV(8F - 1F, 8F - 15F, -1.0F, xOffset + onePixel * 1,
                                    yOffset + onePixel * 15);
        
        tessellator.addVertexWithUV(8F - 0F, 8F - 0F, 0.0F, xOffset + onePixel * 0,
                                    yOffset + onePixel * 0);
        tessellator.addVertexWithUV(8F - 16F, 8F - 0F, 0.0F, xOffset + onePixel * 16,
                                    yOffset + onePixel * 0);
        tessellator.addVertexWithUV(8F - 15F, 8F - 1F, -1.0F, xOffset + onePixel * 15,
                                    yOffset + onePixel * 1);
        tessellator.addVertexWithUV(8F - 1F, 8F - 1F, -1.0F, xOffset + onePixel * 1,
        ...
        tessellator.addVertexWithUV(8F - 15F, 8F - 15F, -1.0F, xOffset + onePixel * 15,
                                    yOffset + onePixel * 15);
        tessellator.addVertexWithUV(8F - 16F, 8F - 16F, 0.0F, xOffset + onePixel * 16,
                                    yOffset + onePixel * 16);
        tessellator.addVertexWithUV(8F - 0F, 8F - 16F, 0.0F, xOffset + onePixel * 0,
                                    yOffset + onePixel * 16);
