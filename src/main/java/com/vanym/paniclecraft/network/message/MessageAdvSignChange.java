...
public class MessageAdvSignChange implements IMessage, IMessageHandler<MessageAdvSignChange, IMessage>{
	int x, y, z;
	byte red, green, blue;
	String text;
	...
	public MessageAdvSignChange(int par1x, int par2y, int par3z, byte par4red, byte par5green, byte par6blue, String par7text){
		this.x = par1x;
		this.y = par2y;
		this.z = par3z;
		this.red = par4red;
