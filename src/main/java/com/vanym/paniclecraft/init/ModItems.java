...
public class ModItems {
    ...
    public static void init(Configuration config) {
        ...
        if (config.getBoolean("Enable", "Broom", true, "")) {
            itemBroom = new ItemBroom(
                    config.getInt("MaxDamage", "Broom", 3072, 0, Integer.MAX_VALUE,
                                  "0 is infinite"),
                    config.get("Broom", "Radius", 6.0D).getDouble(6.0D));
            if (config.getBoolean("Crafting_Broom", "Broom", true, "")) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(itemBroom, 1),
                        new Object[]{"001", "120", "110", Character.valueOf('1'), "stickWood",
                                     Character.valueOf('2'), Items.string}));
            }
        ...
        if (config.getBoolean("Enable", "AdvSign", true, "")) {
            ...
            GameRegistry.registerBlock(blockAdvSignPost, null,
                                       blockAdvSignPost.getUnlocalizedName().substring(5) +
                                           ".post");
            GameRegistry.registerBlock(blockAdvSignWall, null,
                                       blockAdvSignWall.getUnlocalizedName().substring(5) +
                                           ".wall");
            ...
            if (config.getBoolean("Crafting_AdvSign_Easy", "AdvSign", true, "")) {
                GameRegistry.addShapelessRecipe(new ItemStack(itemAdvSign, 1),
                                                new Object[]{Items.sign});
            }
            if (config.getBoolean("Crafting_AdvSign_Hard", "AdvSign", false, "")) {
                GameRegistry.addShapelessRecipe(new ItemStack(itemAdvSign, 1),
                                                new Object[]{Items.sign, Items.book});
            }
            if (config.getBoolean("Crafting_AdvSign_Clear", "AdvSign", true, "")) {
                GameRegistry.addShapelessRecipe(new ItemStack(itemAdvSign, 1),
                                                new Object[]{itemAdvSign});
            }
        }
        ...
        if (config.getBoolean("Enable", "Painting", true, "")) {
            ...
            ItemPaintBrush.brushRadiusSquare =
                    config.getInt("BrushRadiusSquare", "Painting", 3, 1, 1024, "");
            ItemPaintBrush.brushRadiusRound =
                    config.get("Painting", "BrushRadiusRound", 3.5D,
                               "[range: 1 ~ 2048, default: 3.5]", 1.0D, 2048.0D)
                          .getDouble(3.5D);
            ItemPainting.paintingPlaceStack =
                    config.getInt("PaintingPlaceStack", "Painting", 2, 0, 256, "");
            ...
            if (config.getBoolean("Crafting_BigPaintBrush", "Painting", true, "")) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(itemPaintBrush, 1, 0),
        ...
        if (config.getBoolean("Enable", "Chess", true, "")) {
            ...
            GameRegistry.registerBlock(blockChessDesk, null,
                                       blockChessDesk.getUnlocalizedName().substring(5));
            ...
            if (config.getBoolean("Crafting_ChessDesk", "Chess", true, "")) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(itemChessDesk, 1),
                        new Object[]{"w b", "ppp", Character.valueOf('w'),
                                     new ItemStack(Blocks.wool, 1, 0), Character.valueOf('b'),
                                     new ItemStack(Blocks.wool, 1, 15), Character.valueOf('p'),
                                     "plankWood"}));
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(itemChessDesk, 1),
                        new Object[]{"w b", "ppp", Character.valueOf('w'), "blockWoolWhite",
                                     Character.valueOf('b'), "blockWoolBlack",
                                     Character.valueOf('p'), "plankWood"}));
            }
            if (config.getBoolean("Crafting_ChessDesk_Clear", "Chess", true, "")) {
                GameRegistry.addShapelessRecipe(new ItemStack(itemChessDesk, 1),
                                                new ItemStack(itemChessDesk, 1));
            }
        }
        ...
        if (config.getBoolean("Enable", "Cannon", true, "")) {
            ...
            GameRegistry.registerBlock(blockCannon, null,
                                       blockCannon.getUnlocalizedName().substring(5));
            ...
            if (config.getBoolean("Crafting_Cannon", "Cannon", true, "")) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(itemCannon, 1),
                        new Object[]{"i  ", " i ", "idi", Character.valueOf('i'), "ingotIron",
                                     Character.valueOf('d'), Blocks.dispenser}));
            }
        }
        
        if (config.getBoolean("Enable", "PortableWorkbench", true, "")) {
            itemWorkbench = new ItemWorkbench(
                    config.getInt("MaxDamage", "PortableWorkbench", 8192, 0, Integer.MAX_VALUE,
                                  "0 is infinite"));
            registerItem(itemWorkbench);
            if (config.getBoolean("Crafting_PortableWorkbench", "PortableWorkbench", true, "")) {
                GameRegistry.addRecipe(new ShapelessOreRecipe(
                        new ItemStack(itemWorkbench, 1),
                        new Object[]{"craftingTableWood", "stickWood", "stickWood"}));
                GameRegistry.addRecipe(new ShapelessOreRecipe(
                        new ItemStack(itemWorkbench, 1),
                        new Object[]{Blocks.crafting_table, "stickWood", "stickWood"}));
            }
        }
    }
